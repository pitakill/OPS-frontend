  ...
  <Grid container spacing={spacingApp}>
    ...
    <Grid item xs={12} sm={6}>
      <Typography component="h4">
        Si la respuesta es Sí, especifique la fecha de la cirugía
      </Typography>
    </Grid>
    <Grid item xs={12} sm={6}>
    ...
    <Grid item xs={12} sm={6} lg={6}>
      <Typography component="h4">
        Si la resuesta es Sí, especifique el motivo de la cirugía (enfermedad o afección)
      </Typography>
    </Grid>
    <Grid item xs={12} sm={6} lg={6}>
      <TextField
    ...
    <Grid item xs={12} sm={6} lg={6}>
      <Typography component="h4">
        Si la respuesta es Sí ¿fueron los hallazgos utilizados en la certificación?
      </Typography>
    </Grid>
    <Grid item xs={12} sm={6} lg={6}>
      <SelectVariants sections={sections} />
